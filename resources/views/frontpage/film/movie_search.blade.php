        ...
        <div class="row">
            @foreach ($movies as $item)
                ...
                <div class='col-md-2 col-sm-3 mb-5 text-center shadow pt-3'>
                    <h6 class='mb-5'>{{ $item->movie_title }}</h6>
                    <h6><a href="{{ route('company.details', $item->id) }}" class= 'btn btn-success'>Company's
                            Profile</a></h6>
                </div>
            @endforeach
